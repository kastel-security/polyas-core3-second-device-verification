...
function decodePoint(point) {
    const a = (point.x - BigInt(1)) / BigInt(constants.decodingK);
 ...
 * @returns
 */
function decodeMultiPlaintext(multiPlaintext) {
 ...
 * @returns
 */
async function kdfCounterMode(length, seed, label, context) {

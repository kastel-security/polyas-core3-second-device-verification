...
onMounted(async () => {
  env = EnvironmentVariables.init((import.meta as any).env.MODE)
  env.backendUrl = (import.meta as any).env.BACKEND_URL
  env.fingerprint = (import.meta as any).env.SECOND_DEVICE_FINGERPRINT
